...
-- Return the configuration table format expected by vim.lsp.config
return {
	-- Because you used Mason, the executable is automatically in your path
	cmd = { "copilot-language-server", "--stdio" },

	-- The root markers tell the LSP where your project starts
	root_markers = { ".git", "package.json", "Makefile", "compile_commands.json" },
	...
	-- Attach the authentication commands to the buffer when the LSP connects
